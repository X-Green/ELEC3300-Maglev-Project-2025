 ...
 *
 * RESET_DEVICE_IN_STARTUP         - Set all device registers to defaults when TMAG5170startup() is called instead of
 * only the SYSTEM_CONFIG register. DISABLE_CRC_IN_STARTUP          - Disables the CRC calculation and check in the code
 * and, through TMAG5170startup(), on the device as well. (call TMAG5170startup first) SEND_RECIEVE_REDUNDANCY_ENABLED -
 * Reattempt an SPI command once more after a failed CRC verification GLOBAL_CRC_ERROR_VAR_ENABLED    - create a global
 * error variable named crc_error_occurence that will initialize to 0 and flip to 1 upon CRC verification error
 * GLOBAL_INPUT_ERROR_VAR_ENABLED  - Create a global error variable named fcn_input_error_occurence that will initialize
 * to 0 and flip to 1 upon any example code function receiving an invalid input MAX_DELAYS_IN_OPMODE_CHANGES    -
 * Enables delay_us() calls in OPERATING_MODE change functions to account for the max possible delay (outside of deep
 * sleep mode startup situations) the device can take when switching to the desired OPERATING_MODE (delays must be
 * implemented if this is disabled)
 */
 ...
 * |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |              CONV_AVG_NUM[2:0]             |       0      |       0      |       MAG_TEMPCO[1:0] |
 * 0      |             OPERATING_MODE[2:0]            |    T_CH_EN   |    T_RATE    |   T_HLT_EN   | TEMP_COMP_EN |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |        ANGLE_EN[1:0]        |                       SLEEPTIME[3:0]                      | MAG_CH_EN[3:0] |
 * Z_RANGE[1:0]        |         Y_RANGE[1:0]        |         X_RANGE[1:0]        |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |       0      |        DIAG_SEL[1:0]        |       0      |      TRIGGER_MODE[1:0]      |
 * DATA_TYPE[2:0]               |    DIAG_EN   |       0      |       0      |   Z_HLT_EN   |   Y_HLT_EN   |   X_HLT_EN
 * |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |       0      |  ALERT_LATCH |  ALERT_MODE  |  STATUS_ALRT |       0      |       0      | RSLT_ALRT
 * |       0      |       0      |       THRX_COUNT[1:0]       |  T_THRX_ALRT |  Z_THRX_ALRT |  Y_THRX_ALRT |
 * X_THRX_ALRT |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |       0      |      RDY     |       A      |       T      |       Z      |       Y      |       X |
 * 0      |               SET_COUNT[2:0]               |       0      |       0      |       ALRT_STATUS[1:0]      |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |   CFG_RESET  |       0      |       0      |   SENS_STAT  |   TEMP_STAT  |   ZHS_STAT   |   YHS_STAT   |   XHS_STAT
 * |       0      |       0      |       0      |       0      |       0      |       0      |   TRIM_STAT  |   LDO_STAT
 * |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |   ALRT_LVL   |   ALRT_DRV   |   MISO_DRV   |   CRC_STAT   |  FRAME_STAT  |             OPERATING_STAT[2:0] | 0 | 0
 * |    VCC_OV    |    VCC_UV    |   TEMP_THX   |    ZCH_THX   |    YCH_THX   |    XCH_THX   |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |       0      |       0      |       0      |       0      |       0      |       0      |       0 |
 * 0      |      ID      |           VER[1:0]          |       0      |    CRC_DIS   |       OSC_CNT_CTL[1:0]      |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
