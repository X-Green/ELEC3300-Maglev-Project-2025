...
{
void OLED_WR_CMD(uint8_t cmd) { HAL_I2C_Mem_Write(&hi2c3, 0x78, 0x00, I2C_MEMADD_SIZE_8BIT, &cmd, 1, 0x100); }
...
void OLED_WR_DATA(uint8_t data) { HAL_I2C_Mem_Write(&hi2c3, 0x78, 0x40, I2C_MEMADD_SIZE_8BIT, &data, 1, 0x100); }
