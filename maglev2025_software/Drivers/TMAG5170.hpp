 ...
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |              CONV_AVG_NUM[2:0]             |       0      |       0      |       MAG_TEMPCO[1:0]       |       0      |
 * OPERATING_MODE[2:0]            |    T_CH_EN   |    T_RATE    |   T_HLT_EN   | TEMP_COMP_EN |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |     Bit 5    |     Bit 4    |     Bit 3    |     Bit 2    |     Bit 1    |     Bit 0    |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |        ANGLE_EN[1:0]        |                       SLEEPTIME[3:0]                      |                       MAG_CH_EN[3:0] | Z_RANGE[1:0] |
 * Y_RANGE[1:0]        |         X_RANGE[1:0]        |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |     Bit 5    |     Bit 4    |     Bit 3    |     Bit 2    |     Bit 1    |     Bit 0    |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |       0      |        DIAG_SEL[1:0]        |       0      |      TRIGGER_MODE[1:0]      |               DATA_TYPE[2:0] | DIAG_EN
 * |       0      |       0      |   Z_HLT_EN   |   Y_HLT_EN   |   X_HLT_EN   |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |     Bit 5    |     Bit 4    |     Bit 3    |     Bit 2    |     Bit 1    |     Bit 0    |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |       0      |  ALERT_LATCH |  ALERT_MODE  |  STATUS_ALRT |       0      |       0      |   RSLT_ALRT  |       0      |       0 |
 * THRX_COUNT[1:0]       |  T_THRX_ALRT |  Z_THRX_ALRT |  Y_THRX_ALRT |  X_THRX_ALRT |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |    Bit 13    |    Bit 12    |    Bit 11    |    Bit 10    |     Bit 9    |     Bit 8    |     Bit 7    |     Bit 6    |     Bit 5    |     Bit 4
 ...
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |       0      |       0      |      RDY     |       A      |       T      |       Z      |       Y      |       X      |       0      |
 * SET_COUNT[2:0]               |       0      |       0      |       ALRT_STATUS[1:0]      |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |     Bit 5    |     Bit 4    |     Bit 3    |     Bit 2    |     Bit 1    |     Bit 0    |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |   CFG_RESET  |       0      |       0      |   SENS_STAT  |   TEMP_STAT  |   ZHS_STAT   |   YHS_STAT   |   XHS_STAT   |       0      |       0 |
 * 0      |       0      |       0      |       0      |   TRIM_STAT  |   LDO_STAT   |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * VER[1:0]          |       0      |    CRC_DIS   |       OSC_CNT_CTL[1:0]      |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
 ...
 * |     Bit 5    |     Bit 4    |     Bit 3    |     Bit 2    |     Bit 1    |     Bit 0    |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 * |    OFFSET_SELECTION[1:0]    |                                           OFFSET_VALUE1[6:0]                                           |
 * OFFSET_VALUE2[6:0]                                           |
 * |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 */
