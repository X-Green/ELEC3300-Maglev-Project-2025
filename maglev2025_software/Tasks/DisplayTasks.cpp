...
void DisplayUpdate(uint8_t page)
{
    ...
    case DisplayPageBuzzer:
        ...
        if (last_button == GPIO_PIN_SET && HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_10) == GPIO_PIN_RESET)
        {
            ...
            if (lastSubPage != Buzzer_SubPage)
            {
                ...
                case 0:
                    ...
                    Tasks::Music::startMelody(Tasks::Music::melody1,
                                              sizeof(Tasks::Music::melody1) / sizeof(Tasks::Music::melody1[0]));
                    /* code */
                    break;
                case 1:
                    u8g2_DrawStr(&u8g2, 20, 40, "Song 2: Melody 2");
                    Tasks::Music::stopMelody();
                    Tasks::Music::startMelody(Tasks::Music::melody2,
                                              sizeof(Tasks::Music::melody2) / sizeof(Tasks::Music::melody1[0]));
                    /* code */
                    break;
                default:
                    break;
        ...
        // if(Buzzer_SubPage == 0)
        // {
        //     Tasks::Music::startMelody(Tasks::Music::melody1, sizeof(Tasks::Music::melody1) /
        //     sizeof(Tasks::Music::melody1[0])); u8g2_DrawStr(&u8g2, 20, 40, "Song 1: Melody 1");
        // }
        // else if(Buzzer_SubPage == 1)
        // {
        //     Tasks::Music::startMelody(Tasks::Music::melody2, sizeof(Tasks::Music::melody2) /
        //     sizeof(Tasks::Music::melody1[0])); u8g2_DrawStr(&u8g2, 20, 40, "Song 2: Melody 2");
        // }
        // else{
